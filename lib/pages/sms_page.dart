...
import 'package:sms_reader/notification/notification.dart';
...
class _SmsPage extends State<SmsPage> with WidgetsBindingObserver {
                      ...
                      onPressed: () async {
                        if (isStarted == false) {
                          setState(() {
                            isStarted = true;
                            log.messages +=
                                ("${DateTime.now()} isStarted: $isStarted \n");
                          });
                        } else {
                          setState(() {
                            isStarted = false;
